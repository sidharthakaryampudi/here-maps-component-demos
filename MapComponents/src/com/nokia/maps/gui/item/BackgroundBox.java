...
public class BackgroundBox {
    ...
    public BackgroundBox(int borderColor,
            int highlightColor,
            int background, int highlightBackground) {
        this(BackgroundBox.DEFAULT_BORDER_WIDTH, 2, borderColor, highlightColor,
    ...
    public void paint(Graphics g) {
        ...
        if (background != NO_FILL) {
            ...
            g.fillRoundRect(backgroundAnchor.getX(), backgroundAnchor.getY(),
                    backgroundRect.getX(), backgroundRect.getY(),
    ...
    public void setAnchor(int x, int y, int height, int width) {
        ...
        this.borderAnchor = new Point(x - borderAndMargin, y - borderAndMargin);
        this.backgroundAnchor = new Point(x - margin, y - margin);
