...
public class TooltipRenderer extends GUIItemRenderer {
	...
	public TooltipRenderer() {
		this(  WHITE, SMALL_FONT, new BackgroundBox( MID_GREY,
				 MID_GREY, PALE_GREY, PALE_GREY));
	}
	...
	public void setTooltip(Point anchor, String tooltipText) {
		...
		super.setAnchor(anchor.getX() - getGUIData().getWidth()
				/ 2, anchor.getY() + Y_OFFSET + getBorderAndMargin());
	}
