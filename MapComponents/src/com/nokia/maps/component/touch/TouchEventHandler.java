...
public class TouchEventHandler extends AbstractEventListener {
	...
	public boolean pointerReleased(int x, int y) {
		...
		return (component.isGUITouched(x, y) && component.isGUIActive(x, y)) ? component
				.onTouchEventEnd(x, y) : component.isGUITouched(x, y);
	}
	...
	public boolean pointerPressed(int x, int y) {
		return (component.isGUITouched(x, y)) ? component.onTouchEventStart(x,
				y) : component.onTouchEventClear(x, y);
	}
