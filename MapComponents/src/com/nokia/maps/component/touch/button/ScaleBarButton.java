...
public class ScaleBarButton extends TextButton {
    ...
    private final static int[] SCALE_IN_IMPERIAL = new int[] {
        4828000, 2414000,
        1207000, 643737, 321868, 160934, 80467, 40233, 24140, 16093, 8046, 3218,
        1609, 457, 228, 91, 45, 22 };
    private final static String[] SCALE_IN_IMPERIAL_TEXT = new String[] {
        "3000 mi",
        "1500 mi", "750 mi", "400 mi", "200 mi", "100 mi", "50 mi", "25 mi.",
        "15 mi", "10 mi", "5 mi", "2 mi", "1 mi", "500 yds", "250 yds",
    ...
    public ScaleBarButton(int anchor) {
        this(anchor, TextButtonRenderer.WHITE, GUIItemRenderer.SMALL_FONT,
                ...
                TextButtonRenderer.CYAN, TextButtonRenderer.PALE_GREY,
                TextButtonRenderer.CYAN));
    }
