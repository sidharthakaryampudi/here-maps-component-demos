...
public abstract class MapTypeSelector {
	...
	private static final String[] ENGLISH_LABELS = new String[] { "Street Map",
			"Terrain", "Satellite", "Hybrid", "Transit" };

	private static final String SPANISH_COMMAND_TEXT = "Tipo de Mapa";
	private static final String[] SPANISH_LABELS = new String[] { "Callejero",
	...
	protected void commandAction(final Command c, Displayable d) {
		// The default handler does not have any commands associated with it.
	}
