...
public class MapOrientator {
	...
	public static final void  init(MIDlet midlet) {
		if (orientator == null) {
			...
			try {
				Class clazz = Class
						.forName("com.nokia.maps.orientation.FullTouchOrientator");
				
				orientator =  isManualOrientation(midlet) ?  (MapOrientator) clazz.newInstance() : new MapOrientator();
