...
public class ComponentDemo extends MapCanvas implements CommandListener {
    ...
    public ComponentDemo(Display display, MIDlet midlet) {
        ...
        addCityMarker(new GeoCoordinate(60.170833, 24.9375, (float) Float.NaN),
                "Helsinki");
        addCityMarker(new GeoCoordinate(59.949444, 10.756389, (float) Float.NaN),
                "Oslo");

        addCityMarkerMenu(
                new GeoCoordinate(45.4375, 12.335833, (float) Float.NaN),
                "Venice");
    ...
    private void setUpButtons() {
        ...
        ScaleBarButton scale = new ScaleBarButton(
