 ...
 */
public class ScaleBarMidlet extends MIDlet {
     ...
     */
    protected void destroyApp(boolean unconditional) throws MIDletStateChangeException {// TODO Auto-generated method stub
    }
    ...
    protected void startApp() throws MIDletStateChangeException {
        ...
        ScaleBarDemo md = new ScaleBarDemo(display, this);
