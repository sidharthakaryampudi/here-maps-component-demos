...
/**
 * The <code>FallbackTypeSelector</code> uses an <code>EXCLUSIVE ChoiceGroup</code>
 ...
 *
 */
public class FallbackTypeSelector extends TypeSelectorUI implements
        CommandListener {
     ...
     * @throws IOException if no images are available.
     */
    protected FallbackTypeSelector(Display display) throws IOException {
